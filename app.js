document.addEventListener('DOMContentLoaded', () => {
  ...
  const BIOPIC_PILLARS = [
    'Luminaries & Biopic Syntheses'
  ];
  ...
  function renderHomeView() {
    ...
    if (state.currentPortal === 'HealthyGamerGG') {
      ...
      archiveSubtitle.textContent = '15 Iconic Life & Mind Architectures (Musk, Jobs, Marcus Aurelius, Munger, da Vinci, Tesla, Feynman, etc.)';
    } else {
      archiveTitle.textContent = 'The Unified Issue Archive';
      archiveSubtitle.textContent = '71 Master Syntheses across Psychology, Leverage, First Principles & Icon Biopics';
    }
    ...
    else if (state.currentPortal === 'Luminaries & Biopics') featuredArt = articles.find(a => a.id === 'B1.1') || filtered[0];
    ...
    if (featuredArt && state.selectedPillar === 'ALL' && !state.searchQuery) {
      ...
      let tagSub = 'Western Neuroscience + Vedic Psychology + Concrete Protocols';
